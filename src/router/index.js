...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'search-list-article',
        component: () => import('@/views/list/search/article'),
      },
      {
        path: 'search-list-project',
        component: () => import('@/views/list/search/projects'),
      },
      {
        path: 'search-list-application',
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'koni',
        component: () => import('@/views/editor/koni'),
      },
    ],
  },
  {
    ...
    children: [
      {
        path: 'richtext',
        component: () => import('@/views/component/richtext'),
      },
      {
        path: 'tree',
        component: () => import('@/views/component/tree'),
      },
      {
        path: 'split-pane',
        component: () => import('@/views/component/split-pane'),
      },
      {
        path: 'file-upload',
        component: () => import('@/views/component/file-upload'),
      },
    ],
  },
  // 页面不存在
