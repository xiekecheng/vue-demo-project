  ...
  data() {
    return {
      ...
      rules: {
        ...
        province: [
          { required: true, message: '请输入您的所在省!', trigger: 'change' },
        ],
        city: [
          { required: true, message: '请输入您的所在城市!', trigger: 'change' },
        ],
        Country: [
        ...
        profile: [
          { required: true, message: '请输入您的个人简介!', trigger: 'change' },
        ],
        resource: [
        ...
        address: [
          { required: true, message: '请输入您的街道地址!', trigger: 'change' },
        ],
      },
    }
  },
